...
public class ExecutorTest {
    ...
    public void testReuseExecutor() throws Exception {
        ...
        reuseExecutor.doQuery(mappedStatement, 1, RowBounds.DEFAULT, ReuseExecutor.NO_RESULT_HANDLER,
                mappedStatement.getBoundSql(1));
        reuseExecutor.doQuery(mappedStatement, 1, RowBounds.DEFAULT, ReuseExecutor.NO_RESULT_HANDLER,
                mappedStatement.getBoundSql(1));
    ...
    public void sqlSessionTest() {
        ...
        List<Object> courses = sqlSessionFactory.openSession()
                .selectList("com.hcw.learn.mybatis.mapper.CourseMapper.selectAll");
